      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:680px;border-collapse:collapse;background:#ffffff;border:1px solid #e4e4e7;border-radius:12px;overflow:hidden;">
        ...
        <tr><td style="padding:28px;">
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;margin:0 0 24px 0;border:1px solid #e4e4e7;border-radius:10px;overflow:hidden;">
            ...
            <tr><td style="padding:14px 18px;background:#f8fafc;font-size:13px;color:#71717a;border-bottom:1px solid #e4e4e7;">Reporting Period</td><td style="padding:14px 18px;background:#ffffff;font-size:14px;font-weight:700;color:#111827;border-bottom:1px solid #e4e4e7;">{{period}}</td></tr>
            <tr><td style="padding:14px 18px;background:#f8fafc;font-size:13px;color:#71717a;">Deadline</td><td style="padding:14px 18px;background:#ffffff;font-size:15px;font-weight:700;color:#dc2626;">{{deadline}}</td></tr>
          </table>
        ...
        <tr><td style="padding:18px 28px;background:#f8fafc;border-top:1px solid #e4e4e7;"><div style="font-size:12px;line-height:1.6;color:#71717a;">This is an automated message from the PSO-Aurora Report Monitoring System.</div></td></tr>
      </table>
    </td></tr>
  </table>
</div>`,
...
const getDaysUntilDeadline = (deadline, today) => {
...
export const runReportReminders = async ({
  ...
  for (const report of reportList) {
    ...
    const daysUntilDeadline = getDaysUntilDeadline(deadline, today);
