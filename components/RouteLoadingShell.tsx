...
export const RouteLoadingShell: React.FC = () => {
  return (
    <div
      className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.08),_transparent_30%),linear-gradient(180deg,#fafafa_0%,#f4f7fb_55%,#ffffff_100%)] dark:bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.10),_transparent_28%),linear-gradient(180deg,#050505_0%,#090909_55%,#030303_100%)]"
      aria-busy="true"
      aria-live="polite"
    >
